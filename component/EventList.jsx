    ...
    return Object.keys(organizedData).map((month) => (
      <View key={month} className='my-4'>
        {organizedData[month].map((holiday) => (
          <View key={holiday.holiday_id} className='flex flex-col w-full justify-between items-center border-b border-b-lightergrey'>
            ...
            <View className='flex flex-row w-full gap-3 mb-5 mt-2 items-start'>
