                    ...
                    {userCred && Object.keys(userCred).length > 0 ?
                        userCred?.role_id === 4 ?
                            <View className='flex flex-col items-start ml-4'>
                                <Text className='font-bold text-light text-base'>{userCred.first_name} {userCred?.last_name}</Text>
                            ...
                            userTeacherCred && Object.keys(userTeacherCred).length > 0 ?
                                <View className='flex flex-col items-start ml-4'>
                                    <Text className=' text-light text-sm'>Welcome!</Text>
                                    <Text className='font-bold text-light text-base'>{userTeacherCred.first_name} {userTeacherCred?.last_name}</Text>
